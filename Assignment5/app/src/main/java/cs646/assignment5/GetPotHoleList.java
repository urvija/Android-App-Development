...
public class GetPotHoleList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isTwoPane) {
            ...
            startFragment.add(R.id.fragment_for_tablet, new GetPotHoleListFragment());
            startFragment.commit();
        }
        else {
            FragmentTransaction startFragment = getSupportFragmentManager().beginTransaction();
            startFragment.replace(R.id.fragment_for_smaller_screens, new GetPotHoleListFragment());
            startFragment.commit();
        }
    }
