...
public class UserListActivity extends AppCompatActivity {
        ...
        mBackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBatchNumber > 0 || mBatchNumber == 0) {
                    ...
                    cancelAlertDialog();
                    mAlertDialog = Assignment4Helpers.showAlertDialog(UserListActivity.this, R.string
    ...
    private void getPotholesListAndUpdate() {
        ...
        String url = "http://bismarck.sdsu" +
                ".edu/city/batch?type=street&user="+Assignment4Constants
    ...
    private void updateList() {
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(UserListActivity.this,
